...
const AddNew = require("../Pages/AddNew/AddNew").default;
const Completed = require("../Pages/Completed/Completed").default;
const Login = require("../Pages/Login/Login").default;
const Register = require("../Pages/Register/Register").default;
const Layout = require("../layout/Layout").default;
const Trash = require("../Pages/Trash/Trash").default;
const PrivateRoutes = require("./PrivateRoutes").default;
